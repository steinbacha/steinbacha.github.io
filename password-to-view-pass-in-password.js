videojs.registerPlugin('passwordToView', function(pluginOptions) {
  ...
  newElement.innerHTML = '<div><img class="bcls-image" src="https://mindpoollive.com/wp-content/uploads/2020/11/lock-icon.png"><br><input class="theForm" type="password" id="passwordInputID"><br><input id="formButtonID" class="theForm" type="submit" value="Sign In"></div>';
