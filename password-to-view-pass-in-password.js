  ...
  myPlayer.one("loadstart", function() {
    ...
    if (passwordToMatch === undefined) {
      ...
      newElement.innerHTML =
        '<div><img class="bcls-image" src="//learning-services-media.brightcove.com/doc-assets/player-development/samples/password/lock-icon.png"><br><input class="theForm" type="password" id="passwordInputID"><br><input id="formButtonID" class="theForm" type="submit" value="Sign In"><br></div>';
