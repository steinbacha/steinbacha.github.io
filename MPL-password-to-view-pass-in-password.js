videojs.registerPlugin('passwordToView', function(pluginOptions) {
  ...
  newElement.innerHTML = '<div><img class="bcls-image" src="//steinbacha.github.io/white-lock.png"><br><input class="theForm" type="password" id="passwordInputID"><br><br><input id="formButtonID" class="theForm" type="submit" value="Sign In"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>';
